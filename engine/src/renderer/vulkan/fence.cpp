...
namespace nk {
    ...
    void Fence::init(bool is_signaled, Device* device, VkAllocationCallbacks* allocator) {
        ...
        VulkanCheck(vkCreateFence(m_device->get(), &fence_create_info, m_allocator, &m_fence));
    }
    ...
    void Fence::shutdown() {
        ...
        vkDestroyFence(m_device->get(), m_fence, m_allocator);
        m_fence = nullptr;
    }

...
namespace nk::os {
    ...
    void* _native_allocate(cstr file, u32 line, u64 size_bytes, u64 alignment) {
        mem::MemorySystem::native_allocation(file, line, size_bytes, mem::AllocationType::Allocate);
        return malloc(size_bytes);
    }

    void _native_free(cstr file, u32 line, void* data, u64 size_bytes) {
        mem::MemorySystem::native_allocation(file, line, size_bytes, mem::AllocationType::Free);
        free(data);
    }
